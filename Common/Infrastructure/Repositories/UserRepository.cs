...
namespace Infrastructure.Repositories
{
    public class UserRepository : IUser
    {
        ...
        public UserRepository(HazarAuthDbContext hazarAuthDbContext, IConfiguration configuration, ILogUserService loggingService, IApplicationUserRepository applicationUserRepository, ITokenBlacklistService tokenBlacklistService)
        {
            _dbContext = hazarAuthDbContext;
